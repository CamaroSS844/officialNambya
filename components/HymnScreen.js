...
const zoomin = <Feather name="zoom-in" size={25} color={iconcolor} />;
const back = <FontAwesome name="chevron-left" size={25} color={iconcolor} />;
const zoomOut = <Feather name="zoom-out" size={25} color={iconcolor} />;
const close = <Feather name="x" size={25} color={iconcolor} />;
...
export class HymnScreen extends React.Component{
    ...
    render(){
        return (
            ...
            <ScrollView >
                <Text style={{fontSize: this.props.size, color: this.props.theme.color, lineHeight: 25}}>{Combiner(this.id).song}</Text>
            </ScrollView>
            <FAB
